...
class simQAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._pll_L2_win = GrRangeWidget(self._pll_L2_range, self.set_pll_L2, "+B_pll/-B_pll", "counter_slider", float, QtCore.Qt.Horizontal, "value")

        self.top_layout.addWidget(self._pll_L2_win)
        self._pll_L1_range = Range(10, 200, 5, 50, 200)
        self._pll_L1_win = GrRangeWidget(self._pll_L1_range, self.set_pll_L1, "PLL Loop BW", "counter_slider", float, QtCore.Qt.Horizontal, "value")

        self.top_layout.addWidget(self._pll_L1_win)
        self._noiseStd_range = Range(0, 1, 0.01, 0, 200)
        self._noiseStd_win = GrRangeWidget(self._noiseStd_range, self.set_noiseStd, "'noiseStd'", "counter_slider", float, QtCore.Qt.Horizontal, "value")
        ...
        self._BandPass_f_low_win = GrRangeWidget(self._BandPass_f_low_range, self.set_BandPass_f_low, "'BandPass_f_low'", "counter_slider", float, QtCore.Qt.Horizontal, "value")
        ...
        self._BandPass_f_high_win = GrRangeWidget(self._BandPass_f_high_range, self.set_BandPass_f_high, "'BandPass_f_high'", "counter_slider", float, QtCore.Qt.Horizontal, "value")
        ...
        self.blocks_freqshift_cc_0 = blocks.rotator_cc(2.0*math.pi*201/samp_rate)
        ...
        self.connect((self.blocks_freqshift_cc_0, 0), (self.channels_phase_noise_gen_0, 0))
        ...
        self.connect((self.channels_phase_noise_gen_0, 0), (self.blocks_delay_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_freqshift_cc_0.set_phase_inc(2.0*math.pi*201/self.samp_rate)
