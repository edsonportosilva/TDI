...
class testUSRP(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "testUSRP")
        ...
        self.fc = fc = 2453301000

        ##################################################
        # Blocks
        ##################################################
        self._fc_range = Range(2e9, 3e9, 1000, 2453301000, 200)
...
def main(top_block_cls=testUSRP, options=None):
