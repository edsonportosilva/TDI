...
# + hide_input=true
θ, fc, A, t = sp.symbols('θ, f_c, A, t', real=True)
...
def plotCarrier(amp, fase, freq):    
    interval = np.arange(0,0.0025,1e-6)
    sig = c.subs({A:amp, fc:freq, θ:fase})    
    symplot(t, sig, interval, funLabel='c(t)')
        
interact(plotCarrier, amp=(1e-8,10,0.1), fase=(0,2*np.pi,0.1), freq=(1e-3,10010,10));
# -
